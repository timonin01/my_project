...
public class RiskLevelV2TestCases extends CompareJSONV2 {
    ...
    public void test_case_12() throws Exception{
        comparingJSON("rest/v2/risks/test_case_12/request.json", "rest/v2/risks/test_case_12/response.json");
    }

    @Test
    @DisplayName("selected_risks is empty")
    public void test_case_13() throws Exception{
        comparingJSON("rest/v2/risks/test_case_13/request.json", "rest/v2/risks/test_case_13/response.json");
    }

    @Test
    @DisplayName("selected_risks is NOT_SUPPORTED")
    public void test_case_19() throws Exception{
        comparingJSON("rest/v2/risks/test_case_19/request.json", "rest/v2/risks/test_case_19/response.json");
    }

    @Test
    @DisplayName("selected_risks is NOT_SUPPORTED twice")
    public void test_case_20() throws Exception{
        comparingJSON("rest/v2/risks/test_case_20/request.json", "rest/v2/risks/test_case_20/response.json");
    }
