...
import javaguru.travel.insurance.core.repositories.CountryDefaultDayRateRepository;
...
public class CountryDefaultDayRateCalculator {
    ...
    public BigDecimal calculateCountryDefaultDayPremium(TravelCalculatePremiumRequestV1 request){
