...
import org.javaguru.doc.generator.core.messagebroker.proposalack.ProposalGenerationAckQueueSenderImpl;
...
public class ProposalGenerationQueueListener {
    ...
    private final ProposalGenerationAckQueueSenderImpl sender;
    ...
    ProposalGenerationQueueListener(@Value("${rabbitmq.total.retry.count:3}")
                                    ...
                                    ProposalGenerationAckQueueSenderImpl sender) {
    ...
    private void processMessage(Message message) throws Exception {
        ...
        sender.send(agreementDTO,filePath);
    }
