...
class PersonFirstNameFormatValidationTest {
    ...
    public void shouldReturnError(){
        ...
        when(person.getPersonFirstName()).thenReturn("Andrey-Best1");
        ValidationErrorDTO validationError = mock(ValidationErrorDTO.class);
        when(validationErrorFactory.buildError(eq("ERROR_CODE_22"), anyList())).thenReturn(validationError);
    ...
    public void shouldNotReturnError(){
        ...
        when(personDTO.getPersonFirstName()).thenReturn("Andrey-Best");
